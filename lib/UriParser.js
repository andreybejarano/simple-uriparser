...
class UriParser {
  /**
     * parser
     * @description Util for parse url and remplace keys with values of parameter
     * @param {String} uri Url with keys for change :key
     * @param {Object} values Values of key to change
     * @returns {String} Url parsed
     */
  parser(uri, values) {
